...
using easySolutions.easyFestival.WebFrontend;
using easySolutions.easyFestival.WebFrontend.Models;
...
namespace Microsoft.AspNet.Identity 
{
    public static class IdentityExtensions 
    {
        ...
        public static string GetUserId(this IIdentity identity) 
        {
            ...
            if (ci != null) 
            {
                return ci.FindFirstValue(easySolutions.easyFestival.WebFrontend.IdentityConfig.UserIdClaimType);
            }
            return String.Empty;
        }
